...
public class EvictionIterator implements XdrElement {
  ...
  @Override
  public int hashCode() {
    return Objects.hashCode(this.bucketListLevel, this.isCurrBucket, this.bucketFileOffset);
  }
  ...
  public boolean equals(Object object) {
    ...
    return Objects.equal(this.bucketListLevel, other.bucketListLevel)
        && Objects.equal(this.isCurrBucket, other.isCurrBucket)
        && Objects.equal(this.bucketFileOffset, other.bucketFileOffset);
  }
