...
public class ConfigSettingContractLedgerCostV0 implements XdrElement {
  ...
  public boolean equals(Object object) {
    ...
    return Objects.equal(this.ledgerMaxReadLedgerEntries, other.ledgerMaxReadLedgerEntries)
        ...
        && Objects.equal(this.bucketListTargetSizeBytes, other.bucketListTargetSizeBytes)
        && Objects.equal(this.writeFee1KBBucketListLow, other.writeFee1KBBucketListLow)
        && Objects.equal(this.writeFee1KBBucketListHigh, other.writeFee1KBBucketListHigh)
        && Objects.equal(this.bucketListWriteFeeGrowthFactor, other.bucketListWriteFeeGrowthFactor);
  }
