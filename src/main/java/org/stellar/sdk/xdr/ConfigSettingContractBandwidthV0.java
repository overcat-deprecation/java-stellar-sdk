...
public class ConfigSettingContractBandwidthV0 implements XdrElement {
  ...
  @Override
  public int hashCode() {
    return Objects.hashCode(this.ledgerMaxTxsSizeBytes, this.txMaxSizeBytes, this.feeTxSize1KB);
  }
  ...
  public boolean equals(Object object) {
    ...
    return Objects.equal(this.ledgerMaxTxsSizeBytes, other.ledgerMaxTxsSizeBytes)
        && Objects.equal(this.txMaxSizeBytes, other.txMaxSizeBytes)
        && Objects.equal(this.feeTxSize1KB, other.feeTxSize1KB);
  }
