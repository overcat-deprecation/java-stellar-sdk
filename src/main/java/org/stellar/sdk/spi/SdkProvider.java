...
public interface SdkProvider {
   ...
   *
   * <p>Note: Default implementation will use the JDK's {@link java.util.Base64}, and it only works with
   * Android API 26 and above, if you need to support older versions of Android you need to provide
   * your own implementation, <a
